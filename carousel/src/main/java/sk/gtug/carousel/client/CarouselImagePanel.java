...
class CarouselImagePanel extends Composite {
	...
	public ImageRect calculateStepRect(int step, final double stepX,
	...
	public void onResize(int clientWidth, int clientHeight, int width,
			int height) {
