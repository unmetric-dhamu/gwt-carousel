...
public class Carousel extends LayoutPanel implements ClickHandler,
		MouseWheelHandler {
	...
	private boolean isFirstOrLastImage(int delta) {
		return (delta < 0 && actualImageIndex == 0)
				|| (delta > 0 && actualImageIndex == this.imageProvider.size() - 1);
	}
